...
.NOTES
    ...
    LASTEDIT: Feb 14th, 2017, Akos Nagy (dotnetfalcon.com) 
#>
workflow Update-SQLIndexRunbook
{
    ...
    $TableNames = Inlinescript {
        ...
        Write-Verbose "Opening connection to query indices..." 
        # Open the SQL connection
        $Conn.Open()
        Write-Verbose "Connection opened"
        
        Write-Verbose "Querying fragmentation..."
...
"@
        ...
        Write-Verbose "Querying fragmentation done"
 
        Write-Verbose "Querying table names..."
...
"@
        ...
        Write-Verbose "Querying table names done."
